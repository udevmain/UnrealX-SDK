...
class Aes_ctr {
 public:
  static const int MyPasswordLength = 32;
  static const int MyAesBlockSize = 16;
  static const int MyFileKeyLength = 32;
  /**
...
class Aes_ctr_cipher : public Stream_cipher {
 public:
  static const int MyPasswordLength = Aes_ctr::MyPasswordLength;
  static const int MyAesBlockSize = Aes_ctr::MyAesBlockSize;
  static const int MyFileKeyLength = Aes_ctr::MyFileKeyLength;
 ...
 private:
  ...
  unsigned char m_file_key[MyFileKeyLength];
  /* The initialization vector (IV) used to encrypt/decrypt data. */
  unsigned char m_iv[MyAesBlockSize];
