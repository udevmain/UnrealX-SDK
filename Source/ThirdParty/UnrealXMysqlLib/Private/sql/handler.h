...
#pragma warning(disable : 4005 4191 4458 4459 4706 4996 4477 4146 4800 4805 4701 4703 4310)
...
/*
  ...
  Used to mysql_check that no spatial attributes are declared unless
...
/*
  ...
  Used by replication slave to mysql_check if it is possible to retrieve rows from
...
/*
  ...
  Used by optimiser to mysql_check if ranges (as key >= 5) can be optimised
  by index.
*/
...
/*
  ...
  Used to set Key_map keys_for_keyread and to mysql_check in optimiser for
...
/**
  Column type description for foreign key columns compatibility mysql_check.
...
/**
  ...
  @param db                         Database name to mysql_check.
  @param table_name                 table name to mysql_check.
...
/**
  ...
  @param  check_charsets      Indicates whether we need to mysql_check
...
class Alter_inplace_info {
  ...
  */
  ...
  /**
    ...
    using INSTANT algorithm since mysql_check whether table is empty done from
...
class handler {
  ...
  */
  ...
  /**
    ...
    member to true at their start, and mysql_check it before they return: if
  ...
  */
  ...
  /** to be actually called to get 'mysql_check()' functionality*/
  ...
  */
  ...
  /**
    ...
    @note This method is never used for FULLTEXT or SPATIAL keys.
          We rely on handler::ha_table_flags() to mysql_check if such keys
          are supported.
  */
 ...
 public:
  ...
  /**
    ...
    @returns
      ...
      error otherwise
  */
  virtual int engine_push(AQP::Table_access *table_par MY_ATTRIBUTE((unused))) {
    return 0;
  }
  ...
  */
  ...
  /*
    ...
    *) Then we mysql_check if it is impossible even in theory to carry out
  ...
  */
  ...
  virtual int mysql_check(THD *, HA_CHECK_OPT *) { return HA_ADMIN_NOT_IMPLEMENTED; }

  /**
     In this method check_opt can be modified
     to specify CHECK option to use to call mysql_check()
     upon the table.
  */
  ...
  */
   ...
   */
  virtual int prepare_load_table(const TABLE & table_par MY_ATTRIBUTE((unused))) {
    DBUG_ASSERT(false);
    return HA_ERR_WRONG_COMMAND;
  }
   ...
   * @return 0 if success, error code otherwise.
   */
  virtual int load_table(const TABLE & table_par MY_ATTRIBUTE((unused))) {
