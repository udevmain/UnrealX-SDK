...
/**
   ...
   @param COND   Condition to mysql_check
...
/**
   ...
   's', does not recognize, 's' will mysql_check 'e' for
 ...
 public: /* !!! Public in this patch to allow old usage */
  ...
  bool is_trans_keyword() const {
    /*
      ...
      together, strncasecmp is used to mysql_check both cases. they also could be
...
class Rows_log_event : public virtual binary_log::Rows_event, public Log_event {
  ...
  */
  ...
  /*
   ...
   of m_rows_buf mysql_check if is_valid also needs to be modified
  */
  ...
  */
  ...
  /**
    Helper function to mysql_check whether there is an auto increment
